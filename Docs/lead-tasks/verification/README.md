# lead-tasks — visual verification
...
![Dashboard — the one "Needs you" queue — desktop](./dashboard-needs-you.png)
...
| Spec | Verdict | Notes |
|---|---|---|
| [Create Lead Task](../create.md) | Not reviewed |  |
| [Get Lead Tasks](../get-all.md) | Not reviewed |  |
